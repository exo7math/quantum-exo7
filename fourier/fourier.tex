...
\lstick{\ket{k_0}}
 ...
 & \gate{H}
 & \qw
 & \rstick{\ket{0} + e^{2\ii \pi 0..k_0}\ket{1}}\qwa
\\
\lstick{\ket{k_1}}
 & \qw & \qw & \qw       & \qw    & \qw       & \qw
 & \ctrl{3}
 ...
 & \qw
 & \qw
 & \rstick{\ket{0} + e^{2\ii \pi 0..k_1.k_0}\ket{1}}\qwa
\\
 & \vdots
 & 
 & 
...
\lstick{\ket{k_{n-2}}}
 ...
 & \qw
 & \qw
 & \rstick{\ket{0} + e^{2\ii \pi 0..k_{n-2}\ldots k_1.k_0}\ket{1}}\qwa
\\
\lstick{\ket{k_{n-1}}}
 & \qw
 & \gate{H}
 ...
 & \qw
 & \qw
 & \rstick{\ket{0} + e^{2\ii \pi 0..k_{n-1}\ldots k_1.k_0}\ket{1}}\qwa
\\
}
$$}
...
$$
\Qcircuit @C=1em @R=1em {
\lstick{\ket{k_0}} & \qw & \qw      & \qw        & \ctrl{2}   & \qw      & \ctrl{1}  & \gate{H} & \qw & \rstick{\ket{\psi_0}}\qwa \\
\lstick{\ket{k_1}} & \qw & \qw      & \ctrl{1}   & \qw        & \gate{H} & \gate{R_2} & \qw      & \qw & \rstick{\ket{\psi_1}}\qwa \\
...
$$
\Qcircuit @C=1em @R=1em {
\lstick{\ket{k_2}} & \qw & \multigate{2}{SWAP} & \qw
 & \qw      & \qw        & \ctrl{2}
 & \qw      & \ctrl{1}   & \gate{H}
 & \qw      & \rstick{\ket{\psi_0}}\qwa
\\
\lstick{\ket{k_1}} & \qw & \ghost{SWAP}        & \qw
 & \qw      & \ctrl{1}   & \qw
 & \gate{H} & \gate{R_2} & \qw
 & \qw      & \rstick{\ket{\psi_1}}\qwa
\\
\lstick{\ket{k_0}} & \qw & \ghost{SWAP}        & \qw
 & \gate{H} & \gate{R_2} & \gate{R_3}
 & \qw      & \qw        & \qw
 & \qw      & \rstick{\ket{\psi_2}}\qwa
\\
}
$$
